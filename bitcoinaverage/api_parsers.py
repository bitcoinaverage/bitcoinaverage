...
def _localbitcoinsApiCall(usd_api_url, eur_api_url, gbp_api_url, cad_api_url, *args, **kwargs):
    ...
    return {'USD': {'ask': Decimal(usd_result['rates']['last']).quantize(DEC_PLACES),
                                   'bid': None,
                                   'last': Decimal(usd_result['rates']['last']).quantize(DEC_PLACES),
                                   'volume': Decimal(usd_result['volume_btc']).quantize(DEC_PLACES),
            },
            'EUR': {'ask': Decimal(eur_result['rates']['last']).quantize(DEC_PLACES),
                                   'bid': None,
                                   'last': Decimal(eur_result['rates']['last']).quantize(DEC_PLACES),
                                   'volume': Decimal(eur_result['volume_btc']).quantize(DEC_PLACES),
            },
            'GBP': {'ask': Decimal(gbp_result['rates']['last']).quantize(DEC_PLACES),
                                   'bid': None,
                                   'last': Decimal(gbp_result['rates']['last']).quantize(DEC_PLACES),
                                   'volume': Decimal(gbp_result['volume_btc']).quantize(DEC_PLACES),
            },
            'CAD': {'ask': Decimal(cad_result['rates']['last']).quantize(DEC_PLACES),
                                   'bid': None,
                                   'last': Decimal(cad_result['rates']['last']).quantize(DEC_PLACES),
