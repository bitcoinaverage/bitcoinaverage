...
EXCHANGE_LIST = {
                    ...
                    'itbit':  { 'usd_orders_url': 'https://www.itbit.com/api/v2/markets/XBTUSD/orders',
                                'usd_trades_url': 'https://www.itbit.com/api/v2/markets/XBTUSD/trades?since=5930',
                                'sgd_orders_url': 'https://www.itbit.com/api/v2/markets/XBTSGD/orders',
                                'sgd_trades_url': 'https://www.itbit.com/api/v2/markets/XBTSGD/trades?since=5930',
                                'eur_orders_url': 'https://www.itbit.com/api/v2/markets/XBTEUR/orders',
                                'eur_trades_url': 'https://www.itbit.com/api/v2/markets/XBTEUR/trades?since=5930',
                                'display_name': 'itBit',
                                 },
